...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
  <div class="container">
    <a class="navbar-brand fw-bold" href="{{ route('home') }}">AgenciaX</a>
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      <ul class="navbar-nav ms-auto align-items-center">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('paquetes') }}">Paquetes</a></li>
        <li class="nav-item"><a class="nav-link" href="{{ route('paquetes') }}#destinos">Destinos</a></li>
        @auth
...
<footer class="mt-5">
  <div class="container text-white">
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <ul class="list-unstyled">
          <li><a class="text-white" href="{{ route('paquetes') }}">Paquetes</a></li>
          <li><a class="text-white" href="{{ route('paquetes') }}#destinos">Destinos</a></li>
        </ul>
      </div>
      <div class="col-md-4">
        <h6>Contacto</h6>
    ...
    <div class="text-center small mt-3">© {{ date('Y') }} AgenciaX. Todos los derechos reservados.</div>
  </div>
</footer>
